---
title: "Let it Grow: Measurements and Plots of Growth"
subtitle: "Project 1"
author: "Adam M Lee"
...
*Dose*|*Min*|*Max*
------|-----|------
0.5|`r min(dplyr::filter(ToothGrowth,dose==0.5)$len)`|`r max(dplyr::filter(ToothGrowth,dose==0.5)$len)`
1.0|`r min(dplyr::filter(ToothGrowth,dose==1.0)$len)`|`r max(dplyr::filter(ToothGrowth,dose==1.0)$len)`
2.0|`r min(dplyr::filter(ToothGrowth,dose==2.0)$len)`|`r max(dplyr::filter(ToothGrowth,dose==2.0)$len)`
